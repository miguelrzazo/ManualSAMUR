...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Traumatismos/Abdominal/"
tags: []
synonyms: []
related: []
attachments: []
...
* Si el paciente ventila espontáneamente, administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) con un porcentaje y caudal adecuado para mantener SatO2 > 94% o continúe con la ventilación ya iniciada mediante mediante balón de reanimación con reservorio conectado a fuente de [oxígeno](/vademecum?farmaco=oxigeno) 10-12 l/min (alto flujo).
...
* Si se hubiera producido una evisceración:
  ...
  * Cubra asépticamente las heridas.Si un objeto ha producido una herida penetrante:
