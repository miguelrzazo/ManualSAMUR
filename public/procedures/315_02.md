...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Intoxicaciones/Intoxicaci%C3%B3n%20por%20humo/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Intoxicaciones/Intoxicaci%C3%B3n%20por%20humo/WebHome/315_02_alarmasDeteccionGases.pdf","localPath":"/docs/procedures/315_02/315_02_alarmasDeteccionGases.pdf","kind":"pdf"}]
---

* Evalúe la situación (ver el procedimiento operativo de actuación con Bomberos).
* Priorice la **seguridad del personal** del servicio sobre la asistencia sanitaria: Establezca las distancias de seguridad tras consultar las cifras detectadas de tóxicos en la zona de atención.[Ver anexo: Alarmas de detección de gases](/docs/procedures/315_02/315_02_alarmasDeteccionGases.pdf)
...
* Consiga información sobre:
  * Las sustancias a las que el paciente ha podido estar expuesto y sus diversos efectos (detección de gases por Fénix). El humo de un incendio está compuesto por distintos componentes, que varían en su concentración según el material en combustión y que afectan de forma diferente a la víctima:
    ...
    * Partículas
    * Vapor de agua
    * Sustancias que interfieren en el trasporte o la utilización de [oxígeno](/vademecum?farmaco=oxigeno) (ácido cianhídrico y monóxido de carbono)
  ...
  * Factores del paciente que agravan la exposición: con especial atención a los niños y embarazadas. En estas últimas, los niveles de COHb > 10% condicionan el traslado y la administración de [oxígeno](/vademecum?farmaco=oxigeno) hiperbárico (feto con 10-15% más que la madre).
* Valoración inicial ABCD: con especial atención a signos de quemadura inhalatoria, y a signos y síntomas de insuficiencia respiratoria debida a hipoxia tisular (relacionados con la inhalación de aire pobre en [oxígeno](/vademecum?farmaco=oxigeno)), inhalación de gases con toxicidad sistémica (CO y cianhídrico (CN)) o gases irritantes de la vía aérea.
...
* Monitorice signos vitales: TA, FC, FR, ECG, SatO2 y ETCO2
  * La [pulsioximetría](/manual/602_08-medicion-de-sato2) da niveles falsamente elevados de saturación de [oxígeno](/vademecum?farmaco=oxigeno). Sin embargo, es útil para valorar trastornos de la oxigenación, siendo indicativas las tendencias.
  * Determine los niveles de Carboxihemoglobina del paciente (COHb) mediante el Cooxímetro.
* Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) o de bajo flujo (mascarilla con reservorio) según VC del paciente a 10-12 l/min.
* Canalice 1 ó 2 [vías periféricas](/manual/604_03-canalizacion-de-vias-venosas-perifericas).
* Inicie infusión con cristaloides (preferiblemente SSF).
* Aísle vía aérea mediante [intubación endotraqueal](/manual/602_03-intubacion-endotraqueal), lo más precozmente posible, ante situación de coma o signos de **quemadura inhalatoria** como:
...
* Administre <DrugLink name="Hidroxocobalamina" /> iv a dosis de 5 g (70 mg/Kg) diluido en 200 ml de SSF 0,9% en 25-30 min, en los siguientes supuestos:
  ...
  * PCR (en doble dosis).
* Trate los síntomas de cefalea, náuseas/vómitos (Metoclopramida, [Ondansetron](/vademecum?farmaco=ondansetron)) y quemaduras (Técnicas: Tratamiento inicial de las quemaduras) según procedimientos.
...
* Alta en el lugar tras [oxígeno](/vademecum?farmaco=oxigeno) durante la valoración.
...
* Pacientes con alta probabilidad de inhalación aunque haya sido transitoria, con cifras detectadas de tóxicos en niveles altos, en la zona de incendio, con clínica respiratoria, neurológica o cardiovascular moderada, con o sin factores de riesgo personal o que presenten alteraciones en la gasometría arterial o en el ECG.
  ...
  * Valore, según criterios, la perfusión de [Hidroxocobalamina](/vademecum?farmaco=hidroxocobalamina).
* Pacientes con clínica significativa de tipo respiratoria, neurológica o cardiovascular, en que existe alta probabilidad de inhalación y determinaciones de tóxico elevadas.
  ...
  * Evite la obstrucción de la vía aérea superior mediante IOT precoz con [oxigenoterapia](/vademecum?farmaco=oxigeno) al 100%.
  * Corrija la acidosis metabólica.
  * Inicie la perfusión de [Hidroxocobalamina](/vademecum?farmaco=hidroxocobalamina).
