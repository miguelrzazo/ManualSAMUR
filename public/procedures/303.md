...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Analgesia%20y%20sedaci%C3%B3n/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Analgesia%20y%20sedaci%C3%B3n/WebHome/302_evaluacionViaAerea.pdf","localPath":"/docs/procedures/303/302_evaluacionViaAerea.pdf","kind":"pdf"}]
---
...
* Exploración física: Oriéntela a valorar una posible intubación y/o ventilación difícil (ver Manejo avanzado de vía aérea).[Ver Anexo: Evaluación de la vía aérea](/docs/procedures/303/302_evaluacionViaAerea.pdf)
...
* Elija los fármacos y la vía de administración para sedoanalgesia en función de la situación clínica y antecedentes del paciente, perfil del dolor y nivel de sedación y analgesia necesaria. Individualice la dosis para obtener el efecto analgésico adecuado con efectos indeseables mínimos.
  * Si utiliza la [vía intravenosa](/manual/604_05-administracion-de-farmacos-por-via-intravenosa) para la administración de fármacos:
    * Canalice [vía venosa periférica](/manual/604_03-canalizacion-de-vias-venosas-perifericas) y perfunda SSF.
    * Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) suplementaria con mascarilla Venturi con FiO2 y caudal ajustado para garantizar SatO2 entre 94-96%, especialmente en la administración de opiáceos.
...
* Tenga **siempre disponibles antagonistas** de los fármacos utilizados ([flumazenilo](/vademecum?farmaco=flumazenil)-benzodiacepinas/[naloxona](/vademecum?farmaco=naloxona)-mórficos), así como material necesario para ventilar con presión positiva y/o aislar vía aérea del paciente en caso de depresión respiratoria significativa o complicaciones.
* Utilice fármacos para prevenir efectos secundarios:* **Protección gástrica** siempre que utilice AINES: <DrugLink name="Omeprazol" /> iv a dosis de 40 mg.
...
**Morfina** 10 mg = **Meperidina** 100 mg = **[Fentanilo](/vademecum?farmaco=fentanilo)** 0,1 mg

### **Tipos de sedantes disponibles**
#### **Hipnóticos**
* <DrugLink name="Etomidato" /> iv a dosis de 0,2 - 0,4 mg/kg.Inicio de acción: 20 sg.
...
* <DrugLink name="Ketamina" />:
  ...
  * en iv a **dosis hipnótica** de 1-2 mg/kgInicio de acción: 30-60 sg.

Duración de acción: de 5 a 15 min.

  * en im a dosis 3 ó 4 veces la dosis iv (4-6 mg/kg). Utilice esta vía en pacientes de difícil acceso, como segunda alternativa.Duración de acción: de 15 a 25 min.

  * intranasal a dosis de 5 mg/kg.Inicio de acción: 5-10 sg.
...
* <DrugLink name="Midazolam" />:
  * iv a dosis de 0,05 - 0,1 mg/kg iv en bolos lentos (no utilizar más de 2 mg iv en menos de 2 minutos) y titule la dosis cada 2 min.
    * Disminuya un 30% la dosis en asociación con opiáceos. Por ejemplo, en **sinergia con [Fentanilo](/vademecum?farmaco=fentanilo)**: a dosis de 0,03 mg/kg (dosis calculada para 20 años de edad en paciente de 70 kg: 2 mg).
...
* <DrugLink name="Diazepam1" /> iv a dosis de 0,03 - 0,1 mg/kg. Mantenga las mismas precauciones que con el [Midazolam](/vademecum?farmaco=midazolam).
...
1*. <DrugLink name="Paracetamol" /> (1 g) + <DrugLink name="Fentanilo" /> (0,5 mcg/kg). Comience con dosis bajas de [Fentanilo](/vademecum?farmaco=fentanilo) (0,5 mcg/kg).
...
1*. Tras 5 minutos revalúe la respuesta y, si es necesario, repita la dosis de [Ketamina](/vademecum?farmaco=ketamina).
...
* 7. Sedoanalgesia en **cardioversión sincronizada**:
  ...
  * Administre alguno de los siguientes fármacos considerando sus efectos:
    * <DrugLink name="Midazolam" /> iv a dosis de 0,02 - 0,05 mg/kg
      ...
      * Se antagoniza con [flumazenilo](/vademecum?farmaco=flumazenil).
