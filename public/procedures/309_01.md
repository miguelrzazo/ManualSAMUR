...
* Canalice 2 [vías venosas periféricas](/manual/604_02-canalizacion-de-vias-venosas-perifericas), preferiblemente de grueso calibre.
...
* Realice tratamiento etiológico en el caso de que se sepa la causa o desencadenante:
  * **Shock Cardiogénico** ([ver procedimientos de arritmia](/manual/309_04-arritmias), IAM, EAP).
    ...
    * Indique realización de un [Código Infarto](/manual/213-codigo-infarto) (SCACEST) o [Código 16](/manual/213a-codigo-16) (SCASEST) según proceda, o preaviso si su origen es una arritmia.
  ...
  * **Shock Distributivo**:
    ...
    * Shock Neurogénico ([Ver procedimiento de Traumatismo Vertebral. Manejo de shock neurogénico](/manual/304_05-traumatismos-vertebro-medulares)).
