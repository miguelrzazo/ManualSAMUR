...
* Administre <DrugLink name="Adrenalina" /> iv 1 mg en bolo cada 3 a 5 min (tras 3ª [desfibrilación](/manual/603_02-desfibrilacion)). Evite dar adrenalina si sospecha RCE por las cifras elevadas de ETCO2.
...
* Administre <DrugLink name="Adrenalina" /> 1 mg en bolo iv cada 3 a 5 min. Tras cada dosis de Adrenalina, eleve el brazo y administre un bolo de 20 ml de suero.Si no se ha conseguido canalización venosa, utilice vía intraósea si está disponible.
