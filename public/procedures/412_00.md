...
updated: "2026-06-03"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Traumatismos/Valoraci%C3%B3n%20inicial%20del%20paciente%20politraumatizado/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVB/Traumatismos/Valoraci%C3%B3n%20inicial%20del%20paciente%20politraumatizado/WebHome/304_01_EscalaGlasgow.pdf","localPath":"/docs/procedures/412_00/304_01_EscalaGlasgow.pdf","kind":"pdf"}]
---
...
* A la vez que comprueba la respiración, estime el **estado hemodinámico**:
  * Palpe pulso, frecuencia y amplitud, estimando un estado tensional aproximado:Pulso radial presente: > 80 mmHg. de TAS
...
* Calcule la **escala AVDN** (Alerta, reacción al estímulo Verbal, al Dolor o No respuesta) o, en su defecto, mida el componente motor de la [Escala de coma de Glasgow](/docs/procedures/412_00/304_01_EscalaGlasgow.pdf) (GCS).
...
* Si necesita ventilación, utilice el balón de reanimación con reservorio conectado a fuente de [oxígeno](/vademecum?farmaco=oxigeno) (alto flujo).
* Controle aquellas hemorragias masivas que puedan comprometer la vida del paciente en poco tiempo.
* Administre [oxígeno](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) a 10-12 l/min si el paciente ventila espontáneamente.
...
* Observe el tamaño, la simetría y la reactividad pupilar. Calcule la [Escala de coma de Glasgow](/docs/procedures/412_00/304_01_EscalaGlasgow.pdf) (GCS) y efectúe una exploración general de sensibilidad y movilidad.
* Determine [glucemia capilar](/manual/604_13-medicion-de-la-glucemia) (ver Técnica medición glucemia capilar).
...
* Realice una **evaluación sistemática** del paciente, desde la cabeza a los pies y por aparatos.**Cara**
