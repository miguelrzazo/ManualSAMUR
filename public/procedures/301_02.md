...
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/PCR%20Traum%C3%A1tica/WebHome/301b_algoritmo_ERC.pdf","localPath":"/docs/procedures/301_02/301b_algoritmo_ERC.pdf","kind":"pdf"}]
---

[Ver Anexo - Algoritmo ERC 2015](/docs/procedures/301_02/301b_algoritmo_ERC.pdf)
...
[Ver procedimiento Valoración de la escena](/manual/401-valoracion-de-la-escena).
...
* **Para el/los paciente/s**: valore la posible situación de inseguridad del paciente y de las personas que se encuentran en su entorno.
  * Si se encuentra ante una sospecha de incidente NBQ, priorice la información a la Central de Comunicaciones y tome las medidas de autoprotección de manera estricta ([ver procedimiento operativo: Primera respuesta NRBQ](/manual/208-primera-respuesta-nrbq)).
...
* **Maniobras destinadas a optimizar la situación hemodinámica del paciente, controlando las hemorragias internas y externas:**
  ...
  * Realice [analítica venosa](/manual/604_12-analitica-de-sangre) y corrija la acidosis metabólica.
...
* **Maniobras destinadas a optimizar la ventilación del paciente:**
  ...
  * Realice IOT (ver [Intubación endotraqueal](/manual/602_03-intubacion-endotraqueal)).
