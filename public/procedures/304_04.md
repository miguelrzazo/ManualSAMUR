...
section: "SVA"
slug: "304_04-traumatismo-de-torax"
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20traumatol%C3%B3gicas/Traumatismo%20de%20t%C3%B3rax/"
tags: []
synonyms: []
related: []
attachments: []
...
* Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) o de bajo flujo (mascarilla con reservorio) según VC del paciente, a 10-12 l/min, con el objetivo de conseguir SatO2 entre 94-96%.
* Canalice 1 o 2 vías venosas del mayor calibre. Si hay dificultad para conseguir una [vía periférica](/manual/604_03-canalizacion-de-vias-venosas-perifericas) en más de 60 segundos, inserte [vía intraósea](/manual/604_07-via-intraosea-sistema-ez-io). Tome muestra para analítica.
...
* Traslade en USVA con preaviso hospitalario, con el paciente en posición semisentada de no existir contraindicación. Active [Código 15](/codigos?tab=incidente&code=15).
...
* Valore los parámetros gasométricos y de ventilación de cara a mejorar la oxigenación del paciente. Se consideran valores óptimos:
  ...
  * PO2: 80-120 mmHg
* Monitorice constantes de modo reiterativo.
* Corrija los trastornos metabólicos y/o electrolíticos en función de los resultados de la [analítica sanguínea](/manual/604_12-analitica-de-sangre).
* Aplique medidas para reducir la pérdida de calor y evitar la hipotermia. Mantenga la temperatura corporal por encima de 35ºC
* Traslade en USVA con preaviso hospitalario, con el paciente en posición semisentada de no existir contraindicación. Active [Código 15](/codigos?tab=incidente&code=15).
...
* Realice una “resucitación hipotensiva” buscando unos objetivos de tratamiento como los referidos en la siguiente tabla. En general, busque unos valores de TAS entre 80 – 90 mmHg, o una TAM de 65mmHg.|**Tipo de paciente**|**TAS**|**TAM**
...
* Valore la necesidad de una fijación interna (intubación endotraqueal) cuando exista alguno de los siguientes criterios.
  * SatO2 &lt; 90% con O2 o SatO2&lt; 85% tras [oxigenoterapia](/vademecum?farmaco=oxigeno).
  * Ph &lt; 7,10.
  * Pa CO2 > 55 mmHg.
  * FR > 35 o &lt; 8.
...
* Valore los parámetros gasométricos y de ventilación de cara a mejorar la oxigenación del paciente. Se consideran valores óptimos:
  ...
  * PO2: 80-120 mmHg
* Monitorice constantes de modo reiterativo.
* Perfunda fluidos en función del estado hemodinámico, evitando la sobreexpansión según procedimiento de shock hemorrágico de origen traumático y realice reevaluación constante.Tenga en cuenta que estas lesiones suelen ir acompañadas de una contusión pulmonar, por lo que deberá ser especialmente cuidadoso con la administración de fluidos.
...
* Traslade en USVA con preaviso hospitalario. Active [Código 15](/codigos?tab=incidente&code=15).
...
* Corrija los trastornos metabólicos y/o electrolíticos en función de los resultados de la analítica sanguínea
* Aplique medidas para reducir la pérdida de calor y evitar la hipotermia. Mantenga la temperatura corporal por encima de 35ºC
* Se deberá priorizar el traslado urgente para cirugía antes que cualquier otra opción diagnóstica o terapéutica. Traslade en SVA activando el [Código 15](/codigos?tab=incidente&code=15).
...
* Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) o de bajo flujo (mascarilla con reservorio) según VC del paciente, a 10-12 l/min, con el objetivo de conseguir SatO2 entre 94-96%.
* Canalice 1 o 2 vías venosas del mayor calibre. Si hay dificultad para conseguir una vía periférica en más de 60 segundos, inserte vía intraósea. Tome muestra para analítica.
* Monitorice ECG de forma continua. Valore realización de [ECG de 12 derivaciones](/manual/603_01-electrodiagrama-de-12-derivaciones). Descarte isquemia coincidente.
...
* Monitorice constantes de modo reiterativo.
* Corrija los trastornos metabólicos y/o electrolíticos en función de los resultados de la analítica sanguínea.
* Traslade en SVA activando el [Código 15](/codigos?tab=incidente&code=15).
...
* Corrija los trastornos metabólicos y/o electrolíticos en función de los resultados de la analítica sanguínea.
* Aplique medidas para reducir la pérdida de calor y evitar la hipotermia. Mantenga la temperatura corporal por encima de 35ºC
* Traslade en USVA con preaviso hospitalario, valorando la posición semisentada en función del estado hemodinámico. Active [Código 15](/codigos?tab=incidente&code=15).
