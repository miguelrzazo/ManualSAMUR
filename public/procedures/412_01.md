...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Traumatismos/Craneoencef%C3%A1lico/"
tags: []
synonyms: []
related: []
attachments: []
...
Valore el *estado respiratorio* del paciente ([ver procedimiento SVB 'Valoración del paciente'](/manual/402-valoracion-del-paciente-adulto)).

* Valore el *estado circulatorio* del paciente ([ver procedimiento SVB 'Valoración del paciente'](/manual/402-valoracion-del-paciente-adulto)) estando vigilante ante la presencia de pulso lento y pleno.
...
Valore el *estado neurológico* del paciente ([ver procedimiento SVB 'Valoración del paciente'](/manual/402-valoracion-del-paciente-adulto)) determinando:
