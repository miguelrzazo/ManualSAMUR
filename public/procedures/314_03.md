...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/304_01_EscalaGlasgow.pdf","localPath":"/docs/procedures/314_03/304_01_EscalaGlasgow.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_FarmacosEmergenciasPediatricas.pdf","localPath":"/docs/procedures/314_03/314_FarmacosEmergenciasPediatricas.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_MedicacionIntranasal.pdf","localPath":"/docs/procedures/314_03/314_MedicacionIntranasal.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_ParametrosPediatricosEmergencia.pdf","localPath":"/docs/procedures/314_03/314_ParametrosPediatricosEmergencia.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_Tabla1_ParametrosMedicacion_3meses.pdf","localPath":"/docs/procedures/314_03/314_Tabla1_ParametrosMedicacion_3meses.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_Tabla2_ParametrosMedicacion_1ano.pdf","localPath":"/docs/procedures/314_03/314_Tabla2_ParametrosMedicacion_1ano.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_Tabla3_ParametrosMedicacion_5anos.pdf","localPath":"/docs/procedures/314_03/314_Tabla3_ParametrosMedicacion_5anos.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20pedi%C3%A1tricas/Valoraci%C3%B3n%20del%20paciente%20pedi%C3%A1trico%20politraumatizado/WebHome/314_Tabla4_ParametrosMedicacion_9anos.pdf","localPath":"/docs/procedures/314_03/314_Tabla4_ParametrosMedicacion_9anos.pdf","kind":"pdf"}]
---
...
[Ver procedimiento Valoración de la escena](/manual/401-valoracion-de-la-escena) en SVB
...
* Si se encuentra ante una sospecha de incidente NBQ, priorice la información a la Central de Comunicaciones y tome las medidas de autoprotección de manera estricta ([ver procedimiento operativo: NRBQ](/manual/208-primera-respuesta-nrbq)).
...
Al final de esta estimación inicial, se debe de tener una idea preliminar y aproximada del estado del paciente, estando en disposición de realizar una clasificación de víctimas, en el caso de que hubiera más de un paciente o se tratara de un IMV ([Ver procedimiento operativo: Incidente con Múltiples víctimas y Triaje](/manual/207-incidentes-con-multiples-victimas-y-triaje-imv)), y/o de iniciar maniobras de resucitación, si son necesarias.
...
Si es preciso realizar ventilación con presión positiva, hágalo con el **balón de reanimación con reservorio conectado a fuente de [oxígeno](/vademecum?farmaco=oxigeno) (alto flujo)**. Tenga en cuenta las siguientes peculiaridades en la ventilación en el niño:
...
##### **Canalice una [vía venosa periférica](/manual/604_03-canalizacion-de-vias-venosas-perifericas)**
Canalice una vía venosa periférica del mayor calibre que permita el paciente. Si no lo consigue, y necesita urgentemente infundir volumen o medicación, canalice una [vía intraósea](/manual/604_07-via-intraosea-sistema-ez-io). Extraiga, al canalizar la vía, una muestra sanguínea para analítica.
...
* Descarte las lesiones con riesgo inmediato de muerte, principalmente el neumotórax a tensión. Si la clínica es compatible con neumotórax a tensión, confírmelo y evacúelo inmediatamente mediante punción en segundo espacio intercostal línea media clavicular, con angiocatéter conectado posteriormente a válvula de Heimlich. ([ver procedimiento de toracocentesis](/manual/602_06-toracocentesis)).
...
* Insuficiencia respiratoria (hipoventilación o hipoxemia a pesar de [oxígeno](/vademecum?farmaco=oxigeno) al 100% o ventilación con bolsa y mascarilla).
* Parada respiratoria.
...
* Analgésicos. <DrugLink name="Fentanilo" /> iv a dosis de 1-2 mcg/kg. Prepare jeringa de 10 ml con 2 ml de [Fentanilo](/vademecum?farmaco=fentanilo) + 8 ml de suero. Ponga 2 ml/10 kg.
...
Durante el intento de intubación orotraqueal, encargue a una segunda persona del control manual de la columna cervical (columna cervical en línea sin realizar extensión del cuello). Si no es posible realizar [intubación endotraqueal](/manual/602_03-intubacion-endotraqueal), valore otras alternativas (Airtraq® pediátrico, mascarilla laríngea).
...
Si el niño se deteriora tras la toracocentesis con aguja, es posible que el neumotórax a tensión se haya reproducido debido a obstrucción o acodamiento de la cánula; en ese caso repita la toracocentesis con aguja y considere la colocación precoz del drenaje torácico ([ver procedimiento de toracostomía](/manual/602_07-toracostomia-con-sonda-kit-de-drenaje-toracico-portex)).
...
* Si existe hipovolemia, administre 10 - 20 ml/kg de cristaloides (SSF o [Ringer lactato](/vademecum?farmaco=ringer-lactato) tan rápidamente como sea posible (en menos de 20 min). Si los signos de shock persisten, administre un segundo bolo de cristaloides.
...
Considere que la parte motora de la [Escala de coma de Glasgow](/docs/procedures/314_03/304_01_EscalaGlasgow.pdf) puede ser, por sí misma una buena manera de evaluar el nivel de conciencia en el reconocimiento primario. Una puntuación en la parte motora de la [escala de Glasgow](/manual/301_01-cuidados-postparada#escala-de-glasgow) de 4 o menos define 'coma', de forma similar a una puntuación menor de 8 en la escala completa).
...
### Valore los resultados de la [analítica sanguínea](/manual/604_12-analitica-de-sangre)
...
* En pacientes intubados. Adapte el niño a la ventilación durante el traslado mediante:
  * bolos de mantenimiento de <DrugLink name="Midazolam" /> iv lento a dosis de 0,1-0,2 mg/kg, repitiendo cuando sea necesario.
  * Para relajación muscular durante el traslado, emplee <DrugLink name="Rocuronio" /> iv a dosis de 0,6-1 mg/kg.
...
* Ajuste la administración de [oxígeno](/vademecum?farmaco=oxigeno) a las necesidades del paciente. Si sospecha insuficiencia respiratoria o circulatoria, administre [oxígeno](/vademecum?farmaco=oxigeno) para mantener la saturación en al menos 95% (en otros casos puede bastar con 92%). Evite mantener la saturación de [oxígeno](/vademecum?farmaco=oxigeno) al 100%.

Realice historia clínica orientada y breve. Las siglas **AMPLIA** permiten recordar los elementos claves en dicha historia.

* **A**lergias, sobre todo a medicamentos.
* **M**edicaciones actuales (por ejemplo, tratamientos para la epilepsia, diabetes o asma).
* **P**atología (antecedentes médicos), incluyendo cualquier enfermedad crónica que puede explicar los signos físicos, como la espasticidad. 
* **Lí**quidos **I**ngeridos: tiempo desde la última ingesta líquida o sólida, que se relaciona con el riesgo de vómitos y broncoaspiración.
* **A**mbiente (entorno/eventos): información sobre la energía implicada en la lesión y sus posibles consecuencias clínicas, como se mencionó anteriormente.
...
Realice preaviso hospitalario y traslado en USVA al centro de referencia al procedimiento de [Código 15](/codigos?tab=incidente&code=15) en pediatría, priorizando, si las circunstancias lo permiten, el Hospital Niño Jesús, aportando la información necesaria al centro receptor.
...
[Ver anexo - Fármacos de emergencias pediátricas](/docs/procedures/314_03/314_FarmacosEmergenciasPediatricas.pdf)
[Ver anexo - Medicación intranasal pediátrica](/docs/procedures/314_03/314_MedicacionIntranasal.pdf)
[Ver anexo - Parámetros pediátricos en emergencia](/docs/procedures/314_03/314_ParametrosPediatricosEmergencia.pdf)
[Ver anexo - Tabla Parámetros/medicación 3 meses](/docs/procedures/314_03/314_Tabla1_ParametrosMedicacion_3meses.pdf)
[Ver anexo - Tabla Parámetros/medicación 1 año](/docs/procedures/314_03/314_Tabla2_ParametrosMedicacion_1ano.pdf)
[Ver anexo - Tabla Parámetros/medicación 5 años](/docs/procedures/314_03/314_Tabla3_ParametrosMedicacion_5anos.pdf)
[Ver anexo - Tabla Parámetros/medicación 9-10 años](/docs/procedures/314_03/314_Tabla4_ParametrosMedicacion_9anos.pdf)
