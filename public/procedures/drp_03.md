---
id: "drp_03"
title: "Procedimiento De “Cecor” En Un Dispositivo De Riesgo Previsible"
section: "DRP"
slug: "drp_03-procedimiento-de-cecor-en-un-dispositivo-de-riesgo-previsible"
updated: "2026-05-05"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20en%20Dispositivos%20de%20Riesgo%20Previsible%28DRP%29/Procedimiento%20De%20%E2%80%9CCecor%E2%80%9D%20En%20Un%20Dispositivo%20De%20Riesgo%20Previsible/"
tags: []
synonyms: []
related: []
attachments: []
...
1. **Número de identificación del servicio en la aplicación DRP**.
...
1. **Aplicación Informática DRP: número de identificación del servicio.**
...
1. **Operatividad de las unidades.**
...
1. **Asignación de informes y códigos.**
...
1. **Códigos de incidente:**
1*. Códigos 8.12 a 8.15: serán asignados a todas las unidades como clave 2.1 (“informe corto”).
1*. Códigos 8.1 a 8.7:
1**. Unidades de mando/apoyo: serán asignados como clave 2.1 (“informe corto”).
1**. Unidades asistenciales: serán asignados como clave 2 (“informe largo”).
1. **Unidades asistenciales.** Se les asignará un número de informe en clave 2 (“informe largo”). A la llegada al lugar indicado las unidades darán la clave 3 de forma telemática o, en su defecto, por voz. Usarán su número de informe para las diferentes asistencias que realicen. En el caso de que realicen más de una asistencia usarán números de pacientes correlativos (“barras”). Si hicieran un traslado y volvieran al preventivo recibirían un nuevo número de informe.
1. **Unidades o equipos sanitarios a pie (ECO, DEPA). **Se les asignará un número de informe:
1*. Cuando el equipo lo solicite porque se dispone a atender un paciente de forma autónoma, sin que se transfiera a otro recurso de SAMUR-Protección Civil. En caso de atender de forma autónoma a varios heridos en el mismo punto, utilizarán números de pacientes consecutivos (“barras”).
1*. Cuando sea la Central o Base de Comunicaciones quien les asigne un suceso, por trazabilidad. Esta circunstancia se le hará saber expresamente al equipo para que actúen según el criterio general de realización de informes asistenciales.
1*. En caso de realizar exclusivamente acompañamiento del paciente hasta otro tipo de recurso asistencial, el equipo receptor deberá reflejar en su informe (cuadernillo de PSA y/o informe asistencial) qué equipo ECO o DEPA ha hecho la transferencia del paciente y éstos no tendrán que realizar informe propio salvo indicación expresa del CECOR por haberles asignado número de informe.
1*. De forma análoga a los PSA, si así se habilita, los ECO podrán tener su propio cuadernillo (o sistema de filiación digital alternativo) para situaciones de previsión de gran demanda.
1. **Unidades de mando y/o apoyo.**Los códigos e informes asignados a toda aquella unidad que participe en un servicio preventivo y que desarrolle su función exclusivamente como unidad de apoyo o de mando serán asignados en Clave 2.1 (“informe corto”). En el caso de que cualquiera de estos indicativos se encontrara con una asistencia sobrevenida, comunicarán dicha situación al CECOR y solicitarán un número de informe para realizar el informe de la asistencia correspondiente (dando por cerrado el informe previo en clave 2.1).
1. **Unidades de traslado de personal (indicativo “Tango”):** A efectos de informe se considerará como “movimiento interno”.
1. **Traslados de pacientes.**La necesidad de realizar traslado hospitalario por una unidad que participe en el servicio preventivo debe ser valorada y autorizada previamente por el responsable de dicho DRP.
...
1. **Actuación con el Puesto Sanitario Avanzado (PSA):**
...
1*. Asistencias a menores de edad no acompañados.
1*. Asistencias por motivos potencialmente judicializables (agresiones de cualquier índole, desperfectos en vía pública, accidentes de tráfico sobrevenidos, etc.).
1*. En caso de administración de tratamiento parenteral.
1*. Cualquier otro motivo que sea considerado por el personal de soporte vital avanzado que se encuentre prestando servicio en el PSA.
...
1. **Informe al finalizar el evento:**
...
1. **Aplicación Informática DRP: número de identificación de servicio de un DRP.**
Se establece un código de cinco dígitos continuos, seguido del año en curso, separado por una barra (MMDDT/AA):
* **Mes** (dos dígitos)
* **Día** (dos dígitos)
* **Turno de trabajo** (un dígito)
...
1**. Unidades de Mando/Apoyo: serán asignados como clave 2.1 (“informe corto”)
1**. Unidades Asistenciales: serán asignados como clave 2 (“informe largo”)
1. **Unidades Asistenciales:** se encontrarán operativas en “Clave 0”, asignándoles un informe por cada asistencia, quedando en clave 0 al finalizar la intervención. Si realizasen más de una asistencia en el mismo punto usarán número de paciente correlativos (“barras”).
...
1. **Reserva de canales de comunicaciones.**
Se realizará la siguiente distribución de canales de comunicación, salvo decisión del Supervisor responsable del DRP.
\\**Canales:**
1*. SAMUR 6: CICOIN
1*. SAMUR 10: Operatividad vehículos DRP
1*. SAMUR 11: Mandos
1*. SAMUR 12: PSA, ECOS del PSA y Foxtrot
1*. SAMUR 13: Filiación DRP
1*. SAMUR 14: Logística DRP + IMV
1*. SAMUR 15: DEPAS
1*. SAMUR 16: Uros Operativo – IMV
1*. SAMUR 17: ECOS
1*. SAMUR 18: Reservado eventos
...
1*. Se cumplimentará informe asistencial (con número de paciente correlativo) en el PSA en los siguientes casos:
1**. Asistencias a menores de edad no acompañados.
1**. Asistencias por motivos potencialmente judicializables (agresiones de cualquier índole, desperfectos en vía pública, accidentes de tráfico sobrevenidos, etc)
1**. En caso de administración de tratamiento parenteral.
1**. Cualquier otro motivo que sea considerado por el personal de soporte vital avanzado que se encuentre prestando servicio en el PSA.
1*. Una vez finalizado el evento, el *Responsable del DRP*, o en su defecto el *Jefe del PSA* contactará (preferentemente por clave 8) con el responsable del CECOR para proceder con el cierre de los informes realizados.
...
1*. Activará la cadena de mando.
1*. Realizará la gestión del preaviso acorde a los procedimientos habituales del servicio.
...
1. **Orden de servicio, desarrollo del servicio e informe.**
...
1*. Tablet para cumplimentación de informes: Electromedicina.
1*. En caso necesario, vehículo para transporte hasta el CECOR: Oficina del Parque.
1*. Material sanitario, complementario y de comunicaciones: Farmacia.
Se desplazará a la localización donde preste el servicio como Responsable de CECOR (en 2.1), debiendo comunicar la operatividad del vehículo empleado por Canal “SAMUR 2”.
...
1*. Incidencias acontecidas.
1*. Activaciones totales realizadas.
1*. Pacientes atendidos, reflejando los que son vistos por recurso avanzado o solo por recurso básico.
1*. Pacientes trasladados, indicando el tipo de unidad que traslada.
1*. Debe cumplimentarse todos aquellos campos que constan en el informe acorde con el desarrollo del CECOR.
1. Funciones del responsable de CECOR:
\\El Responsable del “CECOR Externo” tiene las siguientes funciones:
1*. Comunicar la Apertura y Cierre del CECOR, así como del propio DRP de SAMUR-Protección Civil si lo hubiera, a la Central de Comunicaciones por canal “SAMUR 2”, indicando el resumen de asistencias realizadas e incidencias destacadas.
1*. Informar al Supervisor de Guardia del comienzo y finalización de su actividad en el CECOR. En el caso de tratarse de personal voluntario (ej. cobertura de CECOR en una UCO), informar al Lima de Guardia, transmitiéndole los datos necesarios para la cumplimentación del informe correspondiente.
1*. Solicitar las unidades a la Central de Comunicaciones en caso de ser necesario durante el desarrollo del DRP.
1*. Coordinar las unidades de SAMUR-Protección-Civil asignadas al DRP o que se dirijan a realizar asistencias a dicho evento, las vías de acceso, los posibles puntos de espera o puntos de reunión de víctimas y cualquier otra necesidad durante el desarrollo del CECOR o el DRP hasta la llegada de un responsable jerárquico superior (en caso de producirse).
1*. Informar a la Central de Comunicaciones de cualquier incidencia o hecho relevante acontecido durante el desarrollo del dispositivo. Asimismo, deberá informar al responsable jerárquico superior en los casos que se contemplen según el manual de procedimientos.
1*. Cumplimentar y cerrar el informe de CECOR al finalizar el servicio y/o la jornada laboral, de la forma descrita previamente.
