...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20Operativos/C%C3%B3digos/C%C3%B3digo%20Infarto/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/C%C3%B3digos/C%C3%B3digo%20Infarto/WebHome/algoritmo_CodigoInfarto.jpg","localPath":"/images/procedures/213/algoritmo_CodigoInfarto.jpg","kind":"image"}]
---
...
### **Definición de caso SCACEST. [Código Infarto](/codigos?tab=incidente&code=INFARTO)**
Serán incluidos como [código infarto](/codigos?tab=incidente&code=INFARTO) los siguientes perfiles de pacientes, atendiendo a sus características clínicas:
...
En términos generales, el tratamiento de reperfusión recomendado en el [código infarto](/codigos?tab=incidente&code=INFARTO) Madrid es la angioplastia primaria. Deberá priorizarse como el tratamiento de elección si el retraso en completarla (tiempo desde primer contacto médico-apertura de la arteria) no es superior a 120 minutos.

Esquema del [código infarto](/codigos?tab=incidente&code=INFARTO) Madrid, de cara a priorizar la estrategia de reperfusión:

![](/images/procedures/213/algoritmo_CodigoInfarto.jpg)

##### **Procedimiento de actuación ante el [Código infarto](/codigos?tab=incidente&code=INFARTO) - Angioplastia primaria**
Ante la inclusión de un paciente en este procedimiento:

* Informe a la central de la existencia de un "[Código infarto](/codigos?tab=incidente&code=INFARTO) prioridad 0”, [código infarto](/codigos?tab=incidente&code=INFARTO) con angioplastia primaria.
* La Central de Comunicaciones activará al jefe de guardia.
* A la llegada del mismo al lugar, este confirmará a la central la existencia del "[Código infarto](/codigos?tab=incidente&code=INFARTO) con angioplastia primaria" para la realización del preaviso.
* Actúe conforme al procedimiento SCACEST **con angioplastia primaria** (ICP) y realice determinación de marcadores cardíacos.
* La central de comunicaciones designará el centro de alerta de hemodinámica del [código infarto](/codigos?tab=incidente&code=INFARTO) donde será remitido el paciente, en función de los siguientes criterios por orden de importancia:
...
* ##### **Procedimiento de actuación ante el [Código infarto](/codigos?tab=incidente&code=INFARTO) - Fibrinolisis**
Ante la inclusión de un paciente en este procedimiento:

* Informe a la Central de la existencia de un "[Código infarto](/codigos?tab=incidente&code=INFARTO) con prioridad 1” o [código infarto](/codigos?tab=incidente&code=INFARTO) con fibrinolisis.
* La central de comunicaciones activará al jefe de guardia.
* A la llegada del mismo al lugar, este confirmará a la Central la existencia del "[Código infarto](/codigos?tab=incidente&code=INFARTO) con fibrinolisis" para la realización del preaviso.
...
* La central de comunicaciones designará el centro de alerta de hemodinámica del [código infarto](/codigos?tab=incidente&code=INFARTO) donde será remitido el paciente tras la fibrinolisis, en función de los siguientes criterios por orden de importancia:
  * Menor tiempo de traslado del paciente (proximidad)
  * Disponibilidad del centro (camas de coronarias, disponibilidad inmediata o próxima de u. de hemodinámica)
