...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Manejo%20avanzado%20de%20v%C3%ADa%20a%C3%A9rea/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Manejo%20avanzado%20de%20v%C3%ADa%20a%C3%A9rea/WebHome/302_evaluacionViaAerea.pdf","localPath":"/docs/procedures/302/302_evaluacionViaAerea.pdf","kind":"pdf"}]
---
...
* Valore el aislamiento de vía aérea según las siguientes indicaciones:
  ...
  * Quemados
    * SCQ > 50%
    * Signos de quemadura inhalatoria ([ver procedimiento: 'paciente quemado'](/manual/313_01-paciente-quemado)).
  * Intoxicados
...
* Apoye la ventilación si fuera necesario:
  * Ventile con balón de reanimación conectado a reservorio con O2 ([oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo con 10-12 l/min) si el paciente está en apnea.
  * Evite la ventilación si el paciente respira espontáneamente y mantiene SatO2 > 90 %.

#### **Premedique (no en PCR)**
Valore el uso de [Atropina](/vademecum?farmaco=atropina) iv en frecuencias bajas a dosis de 0,5 mg.
...
### B)
* <DrugLink name="Etomidato" /> iv a dosis de 0,2 - 0,4 mg/kg. Potencia el efecto del bloqueo neuromuscular.
    +
...
* <DrugLink name="Rocuronio" /> iv en bolos de mantenimiento de:
  * 0,1 - 0,2 mg/kg cada 15-25 min tras primera dosis de [Rocuronio](/vademecum?farmaco=rocuronio) si la actuación es larga. No suele ser necesario dado que la duración del efecto es de 60 min.
  * 1 - 1,5 mg/kg de [Rocuronio](/vademecum?farmaco=rocuronio) tras Succinilcolina (tras 10- 15 min de la administración de ésta o con signos de desadaptación a respirador o inicio de movimiento del paciente).
...
Ver Técnicas: '[Intubación endotraqueal](/manual/602_03-intubacion-endotraqueal)'
...
Valore la aplicación de Videolaringoscopio .
