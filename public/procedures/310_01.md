...
| **Tabla 1. Gravedad de las Exacerbaciones de Asma** | **Parámetros** | **Leve** | **Moderada** | **Grave** | **Paro Respiratorio Inminente** |
| --- | --- | --- | --- | --- | --- |
...
| **Habla con** | Oraciones | Frases cortas | Palabras sueltas |  | **Estado de conciencia** | Puede estar agitado |
| --- | --- | --- | --- | --- | --- | --- |
...
| **Frecuencia Respiratoria** | Aumentada | Aumentada | Generalmente > 30/min |  | **Uso de músculos accesorios y retracciones supraesternales** | Usualmente no |
| --- | --- | --- | --- | --- | --- | --- |
...
| **Sibilancias** | Moderadas a menudo solo al final de la espiración | Fuertes | Usualmente fuertes | Ausentes | **Frecuencia cardiaca** | &lt; 100 lpm |
| --- | --- | --- | --- | --- | --- | --- |
...
| **Pulso paradójico** | Ausente &lt; 10 mm Hg de TAS en inspiración | Puede estar presente 10-25 mm Hg | Suele estar presente > 25 mmHg | Ausente sugiere fatiga de músculos respiratorios | **PaO2 (aire ambiental) PaCO2 |
| --- | --- | --- | --- | --- | --- |
