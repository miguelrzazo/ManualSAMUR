...
updated: "2026-06-03"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Posible%20shock%20hipovol%C3%A9mico/"
tags: []
synonyms: []
related: []
attachments: []
...
* Valore el *estado respiratorio* del paciente, ([ver procedimiento SVB 'Valoración del paciente'](/manual/402-valoracion-del-paciente-adulto)). Observe la presencia de taquipnea (FR > 30 rpm, aproximadamente).
* Valore el *estado circulatorio* del paciente ([ver procedimiento SVB 'Valoración del paciente'](/manual/402-valoracion-del-paciente-adulto)). Observe la presencia de anomalías como:
...
* Realice la *valoración neurológica* ([ver procedimiento SVB 'Valoración del paciente'](/manual/402-valoracion-del-paciente-adulto)).
  * Observe alteraciones del nivel de conciencia, tales como agitación, disminución del nivel de alerta o coma.
...
* Si detecta alteraciones respiratorias o hemodinámicas:
  ...
  * Si no se hubiera realizado con anterioridad, proporcione [oxígeno](/vademecum?farmaco=oxigeno) mediante mascarilla (10 l/min y FiO2 50%), o continúe con la ventilación mediante balón de reanimación conectado a reservorio y O2 a 10-12 l/min ya iniciada.
  ...
  * Si existen hemorragias externas, intente controlarlas con presión directa sostenida, combinada con elevación del miembro afecto. Utilice un vendaje compresivo con gasas, compresas abundantes y venda de crepé, ejerciendo presión sobre la herida ([ver procedimiento técnico de trauma 'Control de hemorragias'](/manual/606_02-control-de-hemorragias)).
...
* Monitorice constantes, TA, FC, FR, glucemia capilar, SatO2 ([pulsioximetría](/manual/602_08-medicion-de-sato2)) prestando especial atención a la existencia de taquicardia, hipotensión arterial y pulso filiforme, que pudieran ser signos de inicio o consolidación del estado de shock.
  * Informe de las siguientes alteraciones en la pulsioximetría: SatO2 &lt; 90% sin [oxígeno](/vademecum?farmaco=oxigeno) o &lt; 92% con [oxígeno](/vademecum?farmaco=oxigeno) que no se normaliza.
  * Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) a 10-12 l/min, para mantener SatO2 > 94%
