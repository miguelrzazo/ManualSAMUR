...
updated: "2026-06-03"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Convulsiones/"
tags: []
synonyms: []
related: []
attachments: []
...
* Administre [oxígeno](/vademecum?farmaco=oxigeno) a bajo flujo (mascarilla con reservorio a 10-12 l/min) para mantener SatO2 de entre 94-96%.
...
* Valore el estado respiratorio y si existen alteraciones, administre [oxígeno](/vademecum?farmaco=oxigeno) a bajo flujo (mascarilla con reservorio a 10-12 l/min) para mantener SatO2 de entre 94-96%. En pacientes con EPOC administre O2 para conseguir una SatO2 de 88-92%
* Valore el estado circulatorio del paciente y si existen alteraciones hemodinámicas:
  * Si no se hubiera realizado con anterioridad, Administre [oxígeno](/vademecum?farmaco=oxigeno) a bajo flujo.
...
* Si persisten las alteraciones tras el episodio convulsivo, el paciente no se recupera del estado postcrítico o vuelve a convulsionar:
  * Si no se hubiera realizado con anterioridad, proporcione [oxígeno](/vademecum?farmaco=oxigeno) mediante mascarilla de adulto con reservorio.
...
* Monitorice constantes del paciente: TA, FR, FC, glucemia capilar (si no lo ha realizado anteriormente), SatO2 ([pulsioximetría](/manual/602_08-medicion-de-sato2)) y esté atento a su evolución.
