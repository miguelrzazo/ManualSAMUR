...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20endocrino-metab%C3%B3licas/Complicaciones%20de%20la%20diabetes/"
tags: []
synonyms: []
related: []
attachments: []
...
* Si es preciso administre **[oxigenoterapia](/vademecum?farmaco=oxigeno)** suplementaria para mantener una SatO2 > 90% (o PaO2 > 60 mmHg).
* Realice [glucemia capilar](/manual/604_13-medicion-de-la-glucemia).
...
* Valore la realización de [ECG de 12 derivaciones](/manual/603_01-electrodiagrama-de-12-derivaciones).
* Realice [analítica venosa](/manual/604_12-analitica-de-sangre) para detectar alteraciones del equilibrio ácido-base, determinación de iones y lactato.
...
* **Si la glucemia es > 250 mg/dl**, previa comprobación de un K+ > 3,3 mEq/l, administre <DrugLink name="Insulinarapida" /> rápida (vial 1000 UI/10 ml: 100 UI/ml):
  ...
  * **Insulina iv:**
**Bolo inicial de 0,1 UI/Kg**, seguido de una **perfusión de 0,1 UI/ Kg/h**. Para ello, prepare una dilución de insulina 1UI/ ml, diluyendo 100 UI de [Insulina rápida](/vademecum?farmaco=insulina-rapida) (1 ml) en 100 ml de SSF 0,9 %.
    * Glucemia > 400 mg/dl.
...
* Canalice [vía periférica](/manual/604_03-canalizacion-de-vias-venosas-perifericas) del mayor calibre posible.
...
* Si el paciente está **inconsciente**:
  ...
  * Valore la administración de 100 mg de <DrugLink name="Hidrocortisona" /> si no hay respuesta a 2 o 3 dosis de [glucosa hipertónica](/vademecum?farmaco=glucosa33).
