...
section: "Operativos"
slug: "214_05-codigo-18-codigo-sepsis"
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20Operativos/C%C3%B3digos/C%C3%B3digo%2018%3A%20C%C3%B3digo%20SEPSIS/"
tags: []
synonyms: []
related: []
attachments: []
...
* Ante la sospecha de una posible infección, valore la **escala qSOFA** (quick-SOFA), que evalúa:
  ...
  * Presión arterial sistólica ≤ 100 mm HgUn valor en esta escala **qSOFA ≥ 2** y la existencia de historia sugestiva de infección, nos hará pensar en la activación del [código 18](/codigos?tab=incidente&code=18), o “Código Sepsis”.
* Canalice [vía venosa periférica](/manual/604_03-canalizacion-de-vias-venosas-perifericas), preferiblemente de grueso calibre y comience a administrar cristaloides
* Administre [oxigenoterapia](/vademecum?farmaco=oxigeno), para mantener SatO2 > 92%
...
* Valore los parámetros de la **escala NEWS** para considerar el riesgo de deterioro clínico:
  ...
  * SatO2
  * [Oxígeno](/vademecum?farmaco=oxigeno) suplementario
  * Temperatura
...
| [Oxigenoterapia](/vademecum?farmaco=oxigeno) |  | Sí |  | No |  |  |  |
...
* Busque signos de disfunción orgánica añadidos a los del qSOFA
  ...
  * Sudoración.
* Realice aislamiento de la vía aérea mediante [intubación endotraqueal](/manual/602_03-intubacion-endotraqueal) antes los siguientes criterios:
...
* ***Bajo preaviso hospitalario, directamente a la UCI***. Como [Código 18](/codigos?tab=incidente&code=18), en aquellas situaciones en las que el paciente:
  ...
  * Cuando tenga una puntuación en la escala NEWS > 7.La central de comunicaciones pondrá en contacto al médico de la unidad con el especialista de UCI de guardia. Además de la historia del paciente, se comunicará el tiempo aproximado de llegada al Hospital.
