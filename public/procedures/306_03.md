...
* En postcrisis considere:
  ...
  * Realice [analítica venosa](/manual/604_12-analitica-de-sangre) para descartar alteraciones hidroelectrolíticas, y analítica arterial, para descartar alteraciones ácido-base. *Valore especialmente el nivel de Lactato* (niveles muy por encima de la normalidad, en este contexto, son sugestivos de crisis convulsivas).
...
### **Estatus Epiléptico**
Este procedimiento debe aplicarse juntamente con el [Código Crisis](/codigos?tab=incidente&code=Crisis) ([Código Crisis](/codigos?tab=incidente&code=Crisis) - SAMUR)
...
* <DrugLink name="Midazolam" />
  ...
  * Vía bucal: 5 mg. En pacientes ancianos o con peso &lt; 40 kg: 2,5 mg. Puede repetir dosis pasados 10 minutos
...
O bien:
  * <DrugLink name="Ketamina" /> (amp. de 500 mg). Por su acción antirreceptores NMDA. Dosis de 50-250 mg (0,5 a 3 mg/kg) en bolo + infusión 1-10 mg/kg/h.

* Valore [intubación endotraqueal](/manual/602_03-intubacion-endotraqueal) si si estatus refractario a tratamiento de más de 30 min de duración o antes de ese tiempo según criterios clínicos y/o gasométricos.
