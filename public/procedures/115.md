...
* La Central de Comunicaciones asignará un número de informe al Psicólogo de Guardia con el **[código 15.5](/codigos?tab=incidente&code=15.5)** (Atención psicológica a intervinientes de SAMUR-Protección Civil).

(1) *Si la unidad precisa [clave 14](/codigos?tab=claves&code=14&subtab=claves) por [clave 6](/codigos?tab=claves&code=6&subtab=claves) la intervención del Romeo se producirá en Base 0. En caso de que la unidad no precise [clave 14](/codigos?tab=claves&code=14&subtab=claves), la intervención se producirá en su base operativa.*

 2. **Sucesos en los que resultan afectados intervinientes sin actuación del Psicólogo de Guardia en el suceso**:

El Psicólogo de Guardia será informado a través de la Central de Comunicaciones de la necesidad de atención inmediata a intervinientes, pasando la unidad a [clave 6](/codigos?tab=claves&code=6&subtab=claves). Se asignará un número de informe con el [código 15.5](/codigos?tab=incidente&code=15.5) y atenderá a las dotaciones de forma grupal y/o individual según necesidades en el lugar definido por el Jefe de Guardia y/o Supervisor.
