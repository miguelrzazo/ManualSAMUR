...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20por%20agentes%20f%C3%ADsicos/Paciente%20con%20hipotermia/"
tags: []
synonyms: []
related: []
attachments: []
...
* Tenga en cuenta:
  ...
  * **Factores de riesgo**: edades extremas, intoxicación etílica, drogas (heroína) o fármacos (beta bloqueantes, antidepresivos tricíclicos, benzodiacepinas, vasodilatadores, opiáceos, litio, [atropina](/vademecum?farmaco=atropina)), enfermedades que producen una disminución del metabolismo (hipotiroidismo, insuficiencia adrenal, desnutrición, inmovilidad), patologías asociadas a un aumento de la pérdida de calor (psoriasis, quemaduras, dermatitis exfoliativas), alteraciones del SNC (ACVA, HSA, lesión medular), personas sin hogar o enfermedad psiquiátrica.
...
* **Garantice una adecuada [oxigenoterapia](/vademecum?farmaco=oxigeno) y ventilación**: mascarilla ventimask 50% a 15 lpm o mascarilla reservorio 100%
  * Si es posible, administre [oxígeno](/vademecum?farmaco=oxigeno) humidificado y caliente (42ºC).
...
* **Canalice 2 [vías venosas periféricas](/manual/604_03-canalizacion-de-vias-venosas-perifericas) de grueso calibre**:
...
* Valore **medidas de recalentamiento interno** en hipotermias graves:
  * Administración de [oxígeno](/vademecum?farmaco=oxigeno) humidificado y caliente (40-42 ºC).
...
1. Determine la concentración sérica de potasio dada su importancia en el pronóstico del paciente. Si la muestra de sangre utilizada en el análisis procede de una [vía intraósea](/manual/604_07-via-intraosea-sistema-ez-io), confirme el resultado con una muestra de sangre obtenida de una vía venosa periférica.
...
1**. Contacte con las unidades hospitalarias para valorar un traslado precoz para RCP extracorpórea. **Calcule el HOPE Score** como elemento fundamental de información para estas unidades ([https:~~/~~/www.hypothermiascore.org](https://www.hypothermiascore.org/)).
1**. No administre [adrenalina](/vademecum?farmaco=adrenalina) mientras la temperatura central se mantenga por debajo de los 30ºC.
...
1**. Administre [adrenalina](/vademecum?farmaco=adrenalina) cada 6 - 10 minutos (doble los intervalos de tiempo de administración de [adrenalina](/vademecum?farmaco=adrenalina) respecto al procedimiento de SVA estándar).
1**. Con respecto a las terapias eléctricas, aplique el procedimiento estándar de SVA.
1**. Si tras 15 minutos de RCP avanzada no se hubiera conseguido ROSC, contacte con las unidades hospitalarias para valorar el traslado para RCP extracorpórea (ECMO). Este traslado será de mayor prioridad, dado el mejor pronóstico, si el HOPE Score calculado fuese ≥ 10 ([https:~~/~~/www.hypothermiascore.org](https://www.hypothermiascore.org/)).
1**. Continúe el resto de las medidas de SVA durante el trayecto. Considere el uso del cardiocompresor.
...
1*. Corrija la hipopotasemia como factor añadido de mal pronóstico.
1*. Realice [analítica venosa](/manual/604_12-analitica-de-sangre) y determinación de glucemia. Proceda a la corrección de las alteraciones hidroelectrolíticas de forma progresiva.
...
1**. Continúe con SG 5% caliente de mantenimiento. ([ver procedimiento de hipoglucemia](/manual/312_01-complicaciones-de-la-diabetes)).
