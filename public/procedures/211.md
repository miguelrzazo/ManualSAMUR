...
updated: "2026-04-24"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20Operativos/Atenci%C3%B3n%20a%20v%C3%ADctimas%20de%20violencia%20sexual/C%C3%B3digo%20VISEM/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/Atenci%C3%B3n%20a%20v%C3%ADctimas%20de%20violencia%20sexual/C%C3%B3digo%20VISEM/WebHome/211_AnexoI.VISEM.pdf","localPath":"/docs/procedures/211/211_AnexoI.VISEM.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/Atenci%C3%B3n%20a%20v%C3%ADctimas%20de%20violencia%20sexual/C%C3%B3digo%20VISEM/WebHome/211_AnexoII.VISEM.pdf","localPath":"/docs/procedures/211/211_AnexoII.VISEM.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/Atenci%C3%B3n%20a%20v%C3%ADctimas%20de%20violencia%20sexual/C%C3%B3digo%20VISEM/WebHome/211_cadenaCustodia.pdf","localPath":"/docs/procedures/211/211_cadenaCustodia.pdf","kind":"pdf"}]
---

### Asistencia a mujeres víctimas de violencia sexual. [Código VISEM](/codigos?tab=incidente&code=VISEM)
...
* **[Código 2.13](/codigos?tab=incidente&code=2.13) (Agresión Sexual).**
* **[Código 2.13.1](/codigos?tab=incidente&code=2.13.1) (Agresión sexual facilitada por drogas, ASFD):** Cuando cumplan al menos uno de los indicadores de sospecha de ASFD o sumisión química.
...
* [Ver Anexo II (Indicadores de sospecha de agresión sexual facilitada por drogas)](/docs/procedures/211/211_AnexoII.VISEM.pdf)

Procedimiento operativo

### 1. Criterios de Activación de [Código VISEM](/codigos?tab=incidente&code=VISEM)
### Criterios de Activación de [Código VISEM](/codigos?tab=incidente&code=VISEM)
### Mujeres ≥ 16 años
**Que haya sufrido una agresión sexual en la que se pueda tomar muestras forenses ***

| **Tiempo trascurrido desde que aconteció el episodio** | ≤ 10 días / 240 h en los casos de existencia de penetración vaginal. ≤ 2 días / 48 h en agresiones sexuales con solo penetración bucal. ≤ 3 días / 72 h en los casos de penetración ano-rectal y para la toma de muestras en superficie corporal** |
| --- | --- |
Que haya inicialmente consentimiento para la activación del código.

*/** Ver comentarios a los “Criterios de inclusión de este código” al final del procedimiento.

### 2. Actuación general de la central de comunicaciones
* Garantice preferentemente la presencia de Policía Municipal en el punto a través de CISEM, acorde a los siguientes criterios de hora y edad del paciente atendido.
  * Mujeres de 16 y/o 17 años:
  ...
  * Mujeres de 18 años o más: Solicite Policía Municipal, garantizando que se informa a la Comisaría de Atención a la Mujer, el Menor y el Mayor.
* En caso de no poder garantizar la presencia de Policía Municipal, solicite la presencia de Policía Nacional. 
* Envíe preferiblemente USVA, con una dotación en la que al menos uno de los componentes que realice la atención sea del mismo sexo que la víctima. Si la primera unidad enviada fuera una unidad de SVB, y sospechara un [código 2.13](/codigos?tab=incidente&code=2.13), solicitará [clave 16](/codigos?tab=claves&code=16&subtab=claves) de una SVA y evitará profundizar en la entrevista, en la medida de lo posible.
* Active al psicólogo de guardia.
* Informe al supervisor de guardia.
* Si cumple los criterios de [Código VISEM](/codigos?tab=incidente&code=VISEM) (protocolo de asistencia sanitaria urgente y coordinada a mujeres víctimas de violencia sexual) una vez confirmado por la unidad en el punto,** la central preavisará el traslado de la mujer al hospital de referencia del código.**
* Hospitales de traslado: H. La Paz, H. Ramón y Cajal, H. Infanta Leonor, H. Gregorio Marañón, H. Central de la Defensa Gómez Ulla, H. 12 de Octubre, H. Clínico San Carlos, H. Fundación Jiménez Díaz

### 3. Valoración y asistencia
* Realice una valoración inicial, poniendo especial atención a la situación del entorno o contexto, con el fin de evaluar la seguridad y ampliar información.
* Se debe proporcionar información inicial básica, incluyendo la necesidad del traslado, comentando en todo momento lo que se está haciendo y recabando el consentimiento verbal explícito, con testigo sanitario o policial.
* Comunique/confirme a la Central la existencia de un [código 2.13](/codigos?tab=incidente&code=2.13) o 2.13.1.
* Actúe conforme al procedimiento terapéutico específico, en función de la patología principal que presente el paciente.
* La comunicación por parte de los profesionales debe ser objetiva, sin juicios de valor ni cuestionamiento del relato, dando apoyo y seguridad, garantizando la confidencialidad, utilizando un lenguaje adecuado a la edad y circunstancias, asegurándose que se entiende lo que se le dice, no forzando a la víctima a responder si no lo desea.
...
* Valore las lesiones físicas y los signos/síntomas de intoxicación para priorizar traslado hospitalario en caso de gravedad frente a los trámites de la denuncia.

Si se trata de un [código VISEM](/codigos?tab=incidente&code=VISEM) la recogida de muestras por el personal sanitario se realizará en el hospital donde se atienda a la mujer. En el caso excepcional de realizar recogida de muestras no biológicas (ropa interior, compresas, otras prendas que puedan contener pruebas):
...
* **Cadena de custodia** (anexo): Identifique cada una de las muestras con el nombre del paciente, fecha, hora y nombre y firma de quien las recoge. Cuando se realice la entrega a terceros se deberá reflejar de igual manera la Fecha, hora, nombre y firma del profesional que las recepciona, con el objetivo de garantizar la cadena de custodia, requisito indispensable para que las pruebas sean consideradas válidas. [Ver anexo - Cadena de custodia](/docs/procedures/211/211_cadenaCustodia.pdf)
...
* Si cumple los criterios de [código VISEM](/codigos?tab=incidente&code=VISEM) se informará a la Central para que preavise al hospital de traslado de la mujer.
* Si no cumple criterios de [código VISEM](/codigos?tab=incidente&code=VISEM) y la víctima **si** desea denunciar:
...
* Si no cumple criterios de [Código VISEM](/codigos?tab=incidente&code=VISEM) y la víctima **no** desea denunciar:
