...
section: "SVA"
slug: "309_04-insuficiencia-cardiaca-aguda-cronica-agudizada"
updated: "2026-06-20"
...
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20cardiovasculares/Insuficiencia%20cardiaca%20aguda%20%20cr%C3%B3nica%20agudizada/WebHome/309_02c_EdemaAgudoPulmon_IC.pdf","localPath":"/docs/procedures/309_04/309_02c_EdemaAgudoPulmon_IC.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20cardiovasculares/Insuficiencia%20cardiaca%20aguda%20%20cr%C3%B3nica%20agudizada/WebHome/309_02c_manejoIC.pdf","localPath":"/docs/procedures/309_04/309_02c_manejoIC.pdf","kind":"pdf"}]
---
...
[Ver anexo - Edema agudo de pulmón-IC](/docs/procedures/309_04/309_02c_EdemaAgudoPulmon_IC.pdf)
...
* Realice [ECG de 12 derivaciones](/manual/603_01-electrodiagrama-de-12-derivaciones) (un ECG normal es raro en una IC). Las alteraciones más frecuentes son: Hipertrofia de cavidades, isquemia o necrosis miocárdica, bloqueos, alteraciones del ritmo o clara arritmia como la fibrilación auricular, alteraciones en la repolarización).
...
* Valore la realización de analítica (iones e INR) y realice gasometría arterial, previa a [oxigenoterapia](/vademecum?farmaco=oxigeno), si la situación clínica lo permite.
* Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) con flujo necesario para mantener SatO2 > 90% (Nivel de evidencia IC) evitando hipoxemia.
...
[Ver anexo - Esquema práctico de manejo de la IC crónica](/docs/procedures/309_04/309_02c_manejoIC.pdf)
...
Administre <DrugLink name="Furosemida" /> iv a dosis de 20 a 40 mg (de 0,5-1 mg/kg) en función de la gravedad (**Nivel de evidencia IB**). Puede repetirse a los 20 min una dosis adicional de 20-40 mg. Pueden combinarse diuréticos de distintos grupos, sobre todo de asa ([furosemida](/vademecum?farmaco=furosemida)) con tiacídicos o espironolactona (si hipopotasemia) v.o., si el paciente dispone de ellos, con mejor resultado clínico.

### Si mejoría clínica con situación similar a la basal
* Si buen apoyo familiar y posibilidad de control por su médico habitual: Valorar alta domiciliaria, con aumento de dosis de [furosemida](/vademecum?farmaco=furosemida) o su introducción durante 2-3 días, restricción hídrica y de sodio, consejos generales y explique signos de alarma.
...
* Si TAS &lt; 90 mmHg:
Administre <DrugLink name="Noradrenalina" /> a dosis de 7-35 µg/min titulando para conseguir el objetivo de perfusión (una TAM ≥ 80 mmHg o TAS 140–180 mmHg).
  ...
  * Utilice <DrugLink name="Dopamina" /> solo en caso de contraindicación o fracaso de [noradrenalina](/vademecum?farmaco=noradrenalina). 
...
* Disnea de reposo, que se refleja normalmente con taquipnea en reposo y con saturación de [oxígeno](/vademecum?farmaco=oxigeno) &lt; 90%.
