...
#### **Síncope cardiovascular sin complicaciones**, se asocia a:
...
#### **Síncope cardiovascular con complicaciones**, se asocia a:
...
* Valore el estado respiratorio del paciente, prestando especial atención a la presencia de disnea. Si SatO2 &lt; 90% administre [oxígeno](/vademecum?farmaco=oxigeno) alto flujo (Venturi) o de bajo flujo (mascarilla con reservorio) a 10-12 l/min.
...
* Reseñe la hora del inicio del dolor y la hora del primer contacto médico con el paciente ([clave 3](/codigos?tab=claves&code=3&subtab=claves)). Tenga preparado el desfibrilador y evite el movimiento activo del paciente.
* Monitorice constantes
...
### **Arritmias**
Una arritmia es un trastorno de la frecuencia cardiaca (taquicardia/ bradicardia) o del ritmo cardiaco (pulso rítmico/arrítmico) ([Ver procedimiento Signos vitales](/manual/601_03-signos-vitales)).
