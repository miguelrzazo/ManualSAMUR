...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Traumatismos/Columna%20vertebral/"
tags: []
synonyms: []
related: []
attachments: []
...
([ver procedimiento 'Valoración inicial del paciente politraumatizado'](/manual/412_00-valoracion-inicial-del-paciente-politraumatizado))
...
* Si necesita ventilación, hágalo con el balón de reanimación con reservorio conectado a fuente de [oxígeno](/vademecum?farmaco=oxigeno) (alto flujo).
* Coloque el pulsioxímetro
* Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) a 10-12 l/min para mantener SatO2 > 94% si el paciente ventila espontáneamente o continúe con la ventilación mediante balón de reanimación conectado a reservorio y O2 a 10-12 l/min ya iniciada.
* Con SatO2 &lt; 90% sin [oxígeno](/vademecum?farmaco=oxigeno) o &lt; 92% con [oxígeno](/vademecum?farmaco=oxigeno) que no se normaliza, informe a la Central para solicitar USVA si no acudiera ya.
...
* Ante cualquier alteración en la valoración inicial, intente estabilizar al paciente:
  ...
  * Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) con mascarilla con reservorio (bajo flujo).
...
([ver procedimiento 'Valoración inicial del paciente politraumatizado'](/manual/412_00-valoracion-inicial-del-paciente-politraumatizado)). Valore la utilización de colchón de vacío.

### **Valoración secundaria y soporte vital**
