...
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVB/Instrumental%20pedi%C3%A1trico/"
tags: []
synonyms: []
related: []
attachments: []
...
* Coloque pulsioxímetro  (será un dato útil para informar y durante la estabilización por USVA). En cualquier caso, mientras el niño se mantenga inconsciente y con respiración espontánea, debe administrar [oxígeno](/vademecum?farmaco=oxigeno) a bajo flujo, 15 l/min con mascarilla con reservorio.
...
* **Realice cinco ventilaciones de un segundo cada**una con balón de reanimación conectado a reservorio y [oxígeno](/vademecum?farmaco=oxigeno) a 15 l/min Para ello:
...
* Realice ventilaciones efectivas con balón de reanimación conectado a reservorio y [oxígeno](/vademecum?farmaco=oxigeno) a 10-12 l/min a un ritmo de 12-20 rpm (una cada 3-5 seg) durante 2 minutos.
...
* Coloque el DEA si no lo ha hecho antes ([ver  procedimiento [desfibrilación](/manual/603_02-desfibrilacion) externa](/manual/406-desfibrilacion-externa-automatica)), sin interrumpir las compresiones.
...
* *Compresiones torácicas en lactantes* (menores de 1 año)**Dos reanimadores**:
