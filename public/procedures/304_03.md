...
section: "SVA"
slug: "304_03-traumatismo-craneoencefalico"
updated: "2026-09-01"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20traumatol%C3%B3gicas/Traumatismo%20craneoencef%C3%A1lico/"
tags: []
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20traumatol%C3%B3gicas/Traumatismo%20craneoencef%C3%A1lico/WebHome/304_01_EscalaGlasgow.pdf","localPath":"/docs/procedures/304_03/304_01_EscalaGlasgow.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20traumatol%C3%B3gicas/Traumatismo%20craneoencef%C3%A1lico/WebHome/304_02_RecomendacionesAltaTCE.pdf","localPath":"/docs/procedures/304_03/304_02_RecomendacionesAltaTCE.pdf","kind":"pdf"}]
---
...
* Evaluación del nivel de conciencia según la [Escala de coma de Glasgow](/docs/procedures/304_03/304_01_EscalaGlasgow.pdf) (GCS).
...
* Valore signos y síntomas en el paciente con traumatismo craneoencefálico no grave.**Relevantes**: Cefalea holocraneal. Vómitos. Pérdida de conciencia. Amnesia postraumática
...
| --- | --- | --- | --- | --- |
| **Glasgow** | 14-15 **Y** uno de los criterios: | 14-15 **Y** uno de los criterios: | 14 **ó** 15 **Y** uno de los criterios: | 15 |
| **Edad** |  | >65 |  |  |
| **Patología previa** | * Enferm. de la coagulación |  |  |  |

* Shunt de derivación por hidrocefalia| | | 
| **Signos y síntomas** | * Convulsiones postraumáticas |
| --- | --- |

* Déficit neurológicos
* Sospecha de Fx craneal| |* Pérdida de conciencia
...
* Si el paciente queda en el lugar, proporciónele **información verbal y escrita** de recomendaciones ante posible evolución.[Ver anexo: Recomendaciones al alta](/docs/procedures/304_03/304_02_RecomendacionesAltaTCE.pdf)
...
* **Evite la hipoxia**. Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) o de bajo flujo (mascarilla con reservorio) según VC del paciente, a 10-12 l/min, con el objetivo de conseguir SatO2 entre 94-96% antes del aislamiento de la vía aérea si precisa.
* Canalice [vía venosa periférica](/manual/604_03-canalizacion-de-vias-venosas-perifericas). Si hay dificultad para conseguir una vía periférica en más de 60 segundos, inserte [vía intraósea](/manual/604_07-via-intraosea-sistema-ez-io).
* Extraiga, al canalizar la vía, una muestra sanguínea para analítica.
* **Evite Hipotensión.** Mantenga niveles de TAM en función de la tabla:|**Edad**|TAS|**TAM**
...
* Valore el aislamiento de la vía aérea mediante [intubación endotraqueal](/manual/602_03-intubacion-endotraqueal).
...
* Traslade siempre en USVA de forma muy lenta y a velocidad constante. Realice preaviso hospitalario. Active [Código 15](/codigos?tab=incidente&code=15).
...
### Procedimiento general
* Coloque collarín cervical.
* **Evite la hipoxia**. Administre [oxigenoterapia](/vademecum?farmaco=oxigeno) a alto flujo (Venturi) a 10-12 l/min, con el objetivo de conseguir SatO2 entre 94-96% antes del aislamiento de la vía aérea si precisa.
...
* **Administre drogas vasoactivas si después de la infusión de 1000 ml de cristaloides, no tuviera respuesta**:
  ...
  * o <DrugLink name="Adrenalina" /> iv en perfusión intravenosa.
    ...
    * Precaución ya que aumenta el consumo cerebral de [oxígeno](/vademecum?farmaco=oxigeno).
* Valore los parámetros gasométricos y de ventilación de cara a mejorar la oxigenación del paciente. Se consideran valores óptimos:
  * ETCO2: 30-35 mmHg
  * PaCO2: 35-40 mmHg
  * PO2: 80-120 mmHg
