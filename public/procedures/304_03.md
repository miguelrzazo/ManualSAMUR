...
* Canalice 1 o 2 vías venosas del mayor calibre. Si hay dificultad para conseguir una [vía periférica](/manual/604_02-canalizacion-de-vias-venosas-perifericas) en más de 60 segundos, inserte [vía intraósea](/manual/604_05b-via-intraosea-sistema-ez-io). Tome muestra para analítica.
...
* Valore los parámetros gasométricos y de ventilación de cara a mejorar la oxigenación del paciente. Se consideran valores óptimos:
  ...
  * PO2: 80-120 mmHg
* Monitorice constantes de modo reiterativo.
* Corrija los trastornos metabólicos y/o electrolíticos en función de los resultados de la [analítica sanguínea](/manual/604_09-analitica-de-sangre).
* Aplique medidas para reducir la pérdida de calor y evitar la hipotermia. Mantenga la temperatura corporal por encima de 35ºC
* Traslade en USVA con preaviso hospitalario, con el paciente en posición semisentada de no existir contraindicación. Active Código 15.
...
* Administre oxigenoterapia a alto flujo (Venturi) o de bajo flujo (mascarilla con reservorio) según VC del paciente, a 10-12 l/min, con el objetivo de conseguir SatO2 entre 94-96%.
* Canalice 1 o 2 vías venosas del mayor calibre. Si hay dificultad para conseguir una vía periférica en más de 60 segundos, inserte [vía intraósea](/manual/604_05b-via-intraosea-sistema-ez-io). Tome muestra para analítica.
