...
section: "Operativos"
slug: "209_01-atencion-sociosanitaria-a-mayores"
updated: "2026-04-30"
...
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/Atenci%C3%B3n%20sociosanitaria%20a%20mayores/WebHome/209b_PersonasMayores_Pfeiffer_Soledad_EASI.pdf","localPath":"/docs/procedures/209_01/209b_PersonasMayores_Pfeiffer_Soledad_EASI.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/Atenci%C3%B3n%20sociosanitaria%20a%20mayores/WebHome/209b_notificacionMayores.pdf","localPath":"/docs/procedures/209_01/209b_notificacionMayores.pdf","kind":"pdf"}]
---

### **Procedimiento de actuación para la atención sociosanitaria a personas mayores en riesgo social o con sospecha de maltrato [código 5.9](/codigos?tab=incidente&code=5.9)**
### Contenido
...
[Ver anexo: Cuestionario de Pfeiffer. Cuestionario de Soledad. EASI.](/docs/procedures/209_01/209b_PersonasMayores_Pfeiffer_Soledad_EASI.pdf)

[Ver anexo: Notificación persona mayor en riesgo social](/docs/procedures/209_01/209b_notificacionMayores.pdf)
...
Para conocer de riesgo social del adulto mayor utilizamos el test [**Elder Abuse Suspicion Index (EASI)**](/docs/procedures/209_01/209b_PersonasMayores_Pfeiffer_Soledad_EASI.pdf). **Para que sea válido, es necesario que el paciente tenga la capacidad cognitiva conservada**.
...
Para detectar la posible existencia de deterioro cognitivo se cuenta con el [**Test de Pfeiffer**](/docs/procedures/209_01/209b_PersonasMayores_Pfeiffer_Soledad_EASI.pdf) el más utilizado por su brevedad y facilidad de manejo, y con una gran fiabilidad. Si el Test de Pfeiffer es superior a 4 la sospecha de riesgo social debe ser estimada por la existencia de otros factores de riesgo.
...
Para conocer el grado de percepción de la soledad y aislamiento, contamos con el [**Cuestionario de soledad**](/docs/procedures/209_01/209b_PersonasMayores_Pfeiffer_Soledad_EASI.pdf) propuesto por la Dirección General de Mayores del Área de Gobierno de Familias, Igualdad y Bienestar Social.
...
* Si existen indicios de situación de riesgo, comunique a la Central de Comunicaciones la existencia de un [Código 5.9](/codigos?tab=incidente&code=5.9). La Central de Comunicaciones de SAMUR-Protección Civil informará precozmente a la Central de Samur Social, en el momento en el que se identifique al paciente como adulto mayor.
...
* **Si el paciente queda en el lugar siendo codificado como 5.9**, la central de comunicaciones de SAMUR-Protección Civil confirmará el [código a](/codigos?tab=icao&code=A) Samur Social, cuya central comunicará su tiempo de respuesta. En aquellas situaciones en las que sea necesaria la intervención social inmediata por la situación de desprotección y/o sospecha de maltrato, y Samur Social no pueda acudir, SAMUR-Protección Civil valorará la posibilidad operativa del traslado del paciente al dispositivo de atención social que se indique desde la central de Samur Social.
