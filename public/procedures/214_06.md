...
Este procedimiento se integra dentro del proceso asistencial de la crisis epiléptica urgente en la Comunidad de Madrid ([Código Crisis](/codigos?tab=incidente&code=Crisis)), código que se extiende a toda el área territorial de la Comunidad de Madrid.
...
### **Definición Estatus Epiléptico. Activación de [Código Crisis](/codigos?tab=incidente&code=Crisis)**
...
Serán incluidos como [código crisis](/codigos?tab=incidente&code=Crisis) los siguientes perfiles de pacientes, atendiendo a sus características clínicas:
...
Si cumple una de las anteriores **excluir la activación** del [código crisis](/codigos?tab=incidente&code=Crisis) en las siguientes situaciones:
...
* La central de comunicaciones designará el hospital de referencia para el [Código Crisis](/codigos?tab=incidente&code=Crisis) en función de los siguientes criterios por orden de importancia:
  * Menor tiempo de traslado del paciente (proximidad).
  * Disponibilidad del centro.
  * Edad del paciente (adulto, pediátrico, neonatal).
* La central de comunicaciones contactará con el hospital de referencia para el [Código Crisis](/codigos?tab=incidente&code=Crisis) elegido por estos criterios, para ampliar la información necesaria:
...
* El centro receptor establecerá los mecanismos que aseguren una recepción directa y adecuada del paciente. El médico responsable del centro receptor designará el lugar donde debe ser ubicado el paciente y tendrá la posibilidad de mantener contacto directo con el medico que realiza el traslado.
  ...
  * En circuito asistencial pediátrico:
    * De 8.00-15.00 en días laborales: neuropediatra encargado del [Código Crisis](/codigos?tab=incidente&code=Crisis) del hospital. En menores de 1 mes avisará a Neonatología para ingreso directo.
...
### **Hospitales de referencia para el [Código Crisis](/codigos?tab=incidente&code=Crisis) epiléptica grave**
Adultos
