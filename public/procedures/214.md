...
synonyms: []
related: []
attachments: [{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/C%C3%B3digos/C%C3%B3digos%201313.1%3A%20Reperfusi%C3%B3n%20precoz%20en%20el%20ictus%20agudo/WebHome/306_02_EscalaNIHSS.pdf","localPath":"/docs/procedures/214/306_02_EscalaNIHSS.pdf","kind":"pdf"},{"sourceUrl":"https://servpub.madrid.es/manualsamur/bin/download/Procedimientos%20Operativos/C%C3%B3digos/C%C3%B3digos%201313.1%3A%20Reperfusi%C3%B3n%20precoz%20en%20el%20ictus%20agudo/WebHome/214_Codigos13.jpg","localPath":"/images/procedures/214/214_Codigos13.jpg","kind":"image"}]
---
...
**[Código 13](/codigos?tab=incidente&code=13)**: Paciente con NIHSS &lt; 10

**[Código 13](/codigos?tab=incidente&code=13).1**: Paciente con NIHSS ≥ 10
...
Fuera de ese horario, (L-V de 13:30– 7:30 h), y horario completo de fines de semana y festivos) se procederá a la selección del paciente conforme al procedimiento, de forma que en los caso de [código 13](/codigos?tab=incidente&code=13).1, el paciente será trasladado directamente al centro de ictus con neurointervencionismo de guardia.
...
El equipo actuante informará a la central de la existencia de un "[código 13](/codigos?tab=incidente&code=13) ó 13.1"

* La central de comunicaciones activará al jefe de guardia.
* Una vez el jefe de guardia esté en [clave 3](/codigos?tab=claves&code=3&subtab=claves), éste solicitará preaviso hospitalario "[código 13](/codigos?tab=incidente&code=13) ó 13.1". En dicho comunicado, se informará de lo siguiente:
...
* *Perfil de paciente: [Código 13](/codigos?tab=incidente&code=13)*: La central de comunicaciones se pondrá en contacto con la **unidad de ictus correspondiente a la zonificación**, para solicitarle un preaviso hospitalario, informándole de las características del paciente descritas por la unidad.
* *Perfil del paciente: [Código 13](/codigos?tab=incidente&code=13).1*: La central de comunicaciones se pondrá en contacto con el** centro de ictus correspondiente a la zonificación**, para solicitarle un preaviso hospitalario, informándole de las características del paciente descritas por la unidad.
* *Perfil del paciente: Ictus distinto a [Código 13](/codigos?tab=incidente&code=13) ó [Código 13](/codigos?tab=incidente&code=13).1*:
  ...
  * La central de comunicaciones tramitará un preaviso hospitalario para un [código 3.13](/codigos?tab=incidente&code=3.13), a hospitales con unidad de ictus.
...
* El equipo sanitario de la unidad, aplicará el procedimiento terapéutico correspondiente, con las variaciones respecto del procedimiento general de ictus aplicables al "[código 13](/codigos?tab=incidente&code=13) o 13.1".
* Cuando la unidad indique la [clave 4](/codigos?tab=claves&code=4&subtab=claves), la Central de Comunicaciones volverá a ponerse en contacto con la emisora de la unidad de ictus o del centro de ictus, a la que informará del tiempo aproximado de llegada, así como de cualquier variación en el estado del paciente que modifique la indicación de [código 13](/codigos?tab=incidente&code=13) o 13.1.
...
* En el informe sanitario que realizará el facultativo de la unidad, se incluirán los siguientes datos:
  ...
  * Sintomatología clínica dominante a la recepción, [escala NIHSS](/docs/procedures/214/306_02_EscalaNIHSS.pdf) y a la transferencia.
