...
related: []
updated: "2026-05-03"
source: "https://www.samurpc.net/data/126.htm"
---
[![Imprimir procedimiento](../images/print.gif) Central de Comunicaciones: Gestión de recursos](javascript:window.print\(\))
...
*   **Aplicación de la Instrucción de la DGEyPc de 30 de octubre de 2013**, relativa a la activación de unidades adscritas a servicios programados de cobertura de actos públicos.
    ...
    Tras ello, y como dice la instrucción, se comunicará el hecho al Lima o Víctor de Guardia, quien informará al organizador del acto. La Central de Comunicaciones sustituirá la unidad asistencial lo más pronto posible.
...
*   Relevos de personal (salvo autorización de la Central de Comunicaciones de prioridad 2 codigo 4.5).
...
*   En enfermos psiquiátricos que puedan poner en riesgo su integridad física o la de la dotación actuante, y sea precisa su sedación o la extensión del correspondiente parte facultativo. Incluye el código 100.
...
*   En general ante cualquier aviso susceptible de códigos especiales (100, 11, 12, 14, etc. a excepción del código 33).
