...
related: []
updated: "2026-05-01"
source: "https://www.samurpc.net/data/125_07.htm"
---
[![Imprimir procedimiento](../images/print.gif) Central de Comunicaciones: Recomendaciones Específicas: Sospecha de parto en curso](javascript:window.print\(\))
...
*   Aconseje, sólo si no respira, que le de un cachete en la nalgas o pellizque la planta de sus pies; esto debe ser suficiente para que rompa a llorar. Si no reacciona, guíe al llamante en la realización de maniobras de resucitación cardiopulmonar neonatal (ver procedimiento [RCP transtelefónica](125_01.htm)).
