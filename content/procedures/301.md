...
---
[![Imprimir procedimiento](../images/print.gif) Procedimientos Asistenciales, SVA: Parada Cardiorespiratoria](javascript:window.print\(\))

PARADA CARDIORRESPIRATORIA

[![](../images/i_graf.gif)Ver gráfico - Algoritmo SVA Adulto](../anexos/algoritmo_SVA.pdf)
...
*   Administre [Adrenalina](# "consultar vademecum") iv 1 mg en bolo cada 3 a 5 min.
...
*   Si no revierte, administre [Amiodarona](# "consultar vademecum") iv a dosis de 300 mg iv en bolo rápido con 20 ml de suero (en cualquier momento durante esos 2 minutos).
...
*   Si no dispone de Amiodarona, administre [Lidocaína Clorhidrato](# "consultar vademecum") iv a dosis de 1 a 1,5 mg/kg en bolo iv.
...
*   En caso de Torsades de Pointes, administre [Sulfato de Magnesio](# "consultar vademecum") iv a dosis de 1 a 2 g iv diluidos en 90 ml de SG al 5%, administrados en 1-2 minutos, que puede repetirse 5-10 minutos después, si no ha sido eficaz.
...
*   CONTINÚE CON CICLOS DE:
    ...
    *   Administre [Adrenalina](# "consultar vademecum") a dosis de 1 mg en bolo iv o **io**, ó 2-2,5 mg vía et cada 3 a 5 min.
...
*   Administre [Bicarbonato Sódico](# "consultar vademecum") 1 M 8,4% iv según la fórmula de cálculo del déficit de bicarbonato solo si pH < 7,10:
...
*   Descarte las causas reversibles (**5 'H' y 5 'T'**) y trate mediante procedimiento específico:
    ...
    *   Si existe [hipopotasemia](312_03.htm) confirmada (< 3,5 mEq/L), administre [Cloruro potásico](# "consultar vademecum") iv (Cloruro potásico, 10 mEq/10 ml ampolla) a dosis de 10 mEq iv en 500 cc de SSF durante la reanimación (velocidad máxima de 2 mEq/min).
...
*   Canalice una [vía venosa](604_02.htm), preferentemente periférica de grueso calibre.
    *   Realice [analítica venosa](604_09.htm) para determinación de pH, EB, iones (K+) y [glucemia](604_10.htm) entre otras.
    *   Si no es posible vía periférica, canalice preferentemente [vía intraósea](604_05b.htm).
*   Administre [Adrenalina](# "consultar vademecum") 1 mg en bolo iv cada 3 a 5 min. Tras cada dosis de Adrenalina, eleve el brazo y administre un bolo de 20 ml de suero.
...
*   Valore las causas reversibles de PCR (**5 'H' y 5 'T'**) y trate en función de éstas:
    ...
    *   Ante sospecha de **hipovolemia** (causa más frecuente), expanda volumen de forma agresiva e inmediata según la posible causa de las pérdidas ([ver procedimiento de shock](309_01.htm)).
    *   Si existe [hiperpotasemia](312_03.htm), actúe como en procedimiento de hiperpotasemia grave.
    *   Si existe [hipopotasemia](312_03.htm) confirmada (< 3,5 mEq/L), administre [Cloruro potásico](# "consultar vademecum") iv (Cloruro potásico, 10 mEq/10 ml ampolla) a dosis de 10 mEq en 500 cc de SSF durante la reanimación (velocidad máxima de 2 mEq/min).
    *   Si existe [hipocalcemia](312_04.htm), administre Gluconato Cálcico iv
    *   Si existe [hipoglucemia](312_01.htm) trátela.
...
*   Canalice una [vía venosa](604_02.htm), preferentemente periférica de grueso calibre.
    ...
    *   Si no es posible vía periférica, canalice preferentemente [vía intraósea](604_05b.htm).
*   Administre [Adrenalina](# "consultar vademecum") iv 1 mg en bolo cada 3 a 5 min. Tras cada dosis de Adrenalina, eleve el brazo y administre un bolo de 20 ml de suero.
