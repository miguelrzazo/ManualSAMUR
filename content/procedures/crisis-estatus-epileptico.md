---
id: "crisis-estatus-epileptico"
title: "Crisis  Estatus epiléptico"
section: "SVA"
slug: "crisis-estatus-epileptico-crisis-estatus-epileptico"
tags: []
synonyms: []
related: []
updated: "2026-05-05"
source: "https://servpub.madrid.es/manualsamur/bin/view/Procedimientos%20asistenciales/Procedimientos%20SVA/Urgencias%20neurol%C3%B3gicas/Crisis%20%20Estatus%20epil%C3%A9ptico/"
---
...
|(% rowspan="2" style="background-color:#50a7d4; width:194px" %)**Lenguaje anormal**|(% style="background-color:#87caed; width:328px" %)**NO**|(% style="background-color:#87caed; width:177px" %)**0**
|(% style="background-color:#87caed; width:328px" %)**SI**|(% style="background-color:#87caed; width:177px" %)**1**
|(% rowspan="2" style="background-color:#50a7d4; width:194px" %)**Desviación ocular**|(% style="background-color:#87caed; width:328px" %)**NO**|(% style="background-color:#87caed; width:177px" %)**0**
|(% style="background-color:#87caed; width:328px" %)**SI**|(% style="background-color:#87caed; width:177px" %)**1**
|(% rowspan="2" style="background-color:#50a7d4; width:194px" %)**Automatismos**|(% style="background-color:#87caed; width:328px" %)**NO**|(% style="background-color:#87caed; width:177px" %)**0**
|(% style="background-color:#87caed; width:328px" %)**SI**|(% style="background-color:#87caed; width:177px" %)**1**
|(% rowspan="3" style="background-color:#50a7d4; width:194px" %)**Número de crisis**|(% style="background-color:#87caed; width:328px" %)**0-1**|(% style="background-color:#87caed; width:177px" %)**0**
|(% style="background-color:#87caed; width:328px" %)**2**|(% style="background-color:#87caed; width:177px" %)**1**
|(% style="background-color:#87caed; width:328px" %)**>2**|(% style="background-color:#87caed; width:177px" %)**2**
|(% colspan="2" style="background-color:#50a7d4; text-align:center; width:521px" %)**Total**|(% style="background-color:#87caed; width:177px" %)**0-5**
...
* Corrija la acidosis metabólica si el pH < 7,20 con <DrugLink name="Bicarbonato Sódico" /> 1 M 8,4% según la fórmula de cálculo del déficit de bicarbonato:
...
* En paciente alcohólicos o en desnutrición grave, administre <DrugLink name="Sulfato de Magnesio" /> iv a dosis de 1,5 g al 50% de concentración: 1 ampolla diluida en 10 ml SSF.
