...
function LaunchScreen() {
  ...
  return <SafeAreaView style={styles.launchScreen} accessibilityViewIsModal>
    ...
    <View style={styles.launchAcademy} accessibilityLabel="by APTA Academy">
      ...
      <Text style={styles.launchByline}>by <Text style={{ color: palette.primary, fontWeight: "900" }}>APTA Academy</Text></Text>
    </View>
  </SafeAreaView>;
}
