...
function createStyles(palette: AdaptivePalette) {
  ...
  orderedMarker: { color: palette.primary, fontSize: 15, lineHeight: 23, fontWeight: "800", minWidth: 22 },
